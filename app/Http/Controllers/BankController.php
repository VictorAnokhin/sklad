...
class BankController extends Controller
{
    ...
    private function pullFmpStockData(string $ticker, string $snapshotDate, array $config): array
    {
        ...
        $data = [
            ...
            'net_debt_ebitda' => $this->formatStockNumber($metrics['netDebtToEBITDA'] ?? null),
    ...
    private function stockAnalysisPayload(Request $request): array
    {
        return $request->validate([
            ...
            'net_debt_ebitda' => ['nullable', 'string', 'max:80'],
            'roe' => ['nullable', 'string', 'max:80'],
            'roic' => ['nullable', 'string', 'max:80'],
