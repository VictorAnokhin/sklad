...
<div class="container mt-4">
    ...
    <div class="card shadow-sm mb-4 border-dark-subtle">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                <div><h3 class="mb-1">Forecast продажів</h3><div class="text-muted small">Період бази: {{ $monthLabel }}</div></div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3"><div class="rounded border p-3 h-100"><div class="text-muted small mb-1">Forecast продажів</div><div class="fs-4 fw-bold text-dark">{{ number_format((float) $forecastDocs, 0, '.', ' ') }}</div></div></div>
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-4"><div class="rounded border p-3 h-100"><div class="text-muted small mb-1">Факт виручки</div><div class="fs-5 fw-bold text-dark">{{ number_format((float) $actualRevenue, 2, '.', ' ') }} грн</div><div class="text-muted small mt-1">План/факт {{ number_format((float) $planFactRevenuePercent, 1, '.', ' ') }}%</div></div></div>
                <div class="col-md-4"><div class="rounded border p-3 h-100"><div class="text-muted small mb-1">Факт продажів</div><div class="fs-5 fw-bold text-dark">{{ number_format((float) $actualDocs, 0, '.', ' ') }}</div><div class="text-muted small mt-1">План/факт {{ number_format((float) $planFactDocsPercent, 1, '.', ' ') }}%</div></div></div>
                <div class="col-md-4"><div class="rounded border p-3 h-100"><div class="text-muted small mb-1">Факт одиниць</div><div class="fs-5 fw-bold text-dark">{{ number_format((float) $actualQty, 2, '.', ' ') }}</div><div class="text-muted small mt-1">План/факт {{ number_format((float) $planFactQtyPercent, 1, '.', ' ') }}%</div></div></div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4">
        <div class="col-lg-5">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    <h4 class="card-title mb-3">Сезонність попиту</h4>
        ...
        <div class="col-lg-7">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    <h4 class="card-title mb-3">Forecast по сегментах</h4>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="text-muted small mb-2">Категорії</div>
                            <div class="table-responsive">
                                <table class="table table-sm align-middle mb-0">
                                    <thead><tr><th>Сегмент</th><th class="text-end">Forecast</th></tr></thead>
                                    <tbody>
    ...
    <div class="card shadow-sm mt-4">
        <div class="card-body">
            <h4 class="card-title mb-3">Історія по місяцях</h4>
            <div class="table-responsive">
                <table class="table table-sm align-middle mb-0">
                    <thead><tr><th>Місяць</th><th class="text-end">Продажів</th><th class="text-end">Одиниць</th><th class="text-end">Виручка</th></tr></thead>
                    <tbody>
