...
<div class="container mt-4">
    ...
    <div class="card shadow-sm mb-4 border-dark-subtle">
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-6"><div class="rounded border p-3 h-100"><div class="text-muted small mb-1">План закупок, од.</div><div class="fs-4 fw-bold text-dark">{{ number_format((float) $plannedPurchaseQtyTotal, 2, '.', ' ') }}</div></div></div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <h4 class="card-title mb-3">Товари до закупівлі</h4>
            <div class="table-responsive">
                <table class="table table-sm align-middle mb-0">
                    <thead><tr><th>Товар</th><th>Код</th><th class="text-end">Поточний залишок</th><th class="text-end">Сер. попит / міс</th><th class="text-end">Плановий попит</th><th class="text-end">Докупить</th><th class="text-end">Сума</th></tr></thead>
                    <tbody>
