            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="glass-card">
                        <h2 class="h5 text-light mb-3">Новый тариф</h2>
                ...
                <div class="col-lg-8">
                    <div class="subscription-stack">
                        @forelse($plans as $plan)
                            <article class="glass-card subscription-card">
                                <div class="subscription-card__head">
                                    ...
                                    <span class="badge {{ $plan->active ? 'bg-success' : 'bg-secondary' }}">{{ $plan->active ? 'Активен' : 'Выключен' }}</span>
                                </div>
                        ...
                        @empty
                            <div class="alert alert-secondary">Создайте первый тариф подписки.</div>
                        @endforelse
                    </div>
                </div>
            </div>
