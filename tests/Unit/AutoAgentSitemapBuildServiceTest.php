...
PHP);
        ...
        config()->set('services.autoagent_sitemap.source_url', 'https://av8.fund/sitemap.xml?fid=12');
        ...
        $this->assertSame("https://av8.fund/sitemap.xml?fid=7\n/tmp/autoagent-sitemap.xml", $result['output']);
    }
    ...
    public function test_missing_script_is_skipped_without_failure(): void
    {
        ...
        config()->set('services.autoagent_sitemap.source_url', 'https://av8.fund/sitemap.xml');
